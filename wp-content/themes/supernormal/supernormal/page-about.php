...
<div class="container2">
    <div class="main2">
        <div class="left">
            ...
            <h5 style="line-height: 2vw;">From rearranging my room to perfecting the flow of my daily routine, I’ve always had a habit of optimizing space and removing inefficiencies. It’s not just about aesthetics—it’s about crafting an environment that works seamlessly with how I move, live, and think. <br><br>This mindset naturally extends to my work as a UX designer, where I’m constantly thinking, “How can this be more intuitive, more efficient?” <br><br>Whether it’s reshaping a digital product or improving a physical layout, I’m always seeking to enhance the flow and efficiency of a user’s journey, both physically and digitally.</h5>
        </div>
        <div class="right">
            <img style="margin-top: 100px; margin-left: 73px; height: 30vw;" src=<?php echo esc_url( get_template_directory_uri() . ('/img/ProfilePhoto.jpg')); ?> >
        </div>
    </div>
    ...
    <div class="container">
        <h2>A Glimpse Into My Interests</h2>
        ...
        <div class="body" style="align-items: center;">
            <h2>Crafted with Care and Code</h2>
